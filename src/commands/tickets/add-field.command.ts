...
import {
	addBotTicketField,
	BotTicketFieldType,
	BotTicketFieldTypeChoices,
	getBotTicketChannelByDiscordId,
	getBotTicketChannelFieldCount
} from "../../logic.js";
...
export default defineSubcommand({
	...
	async execute(interaction) {
		...
		const fieldCountResult = await getBotTicketChannelFieldCount(ticketChannel);
		...
		const addFieldResult = await addBotTicketField(ticketChannel, {
			label,
